...
import { Mail, Lock, Globe, Users, Link2, Sparkles, Film } from "lucide-react"
...
export default function OSINTToolGrid() {
  ...
  if (expandedTool === "image-ai") return <AdvancedImageAnalyzer onBack={() => setExpandedTool(null)} />
  if (expandedTool === "video-ai") return <AdvancedVideoAnalyzer onBack={() => setExpandedTool(null)} />
